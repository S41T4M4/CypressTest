...
namespace ConciliadoraTestes.Testes.Seguranca.GrupoSeguranca
{
    public class MetodosGrupoSeguranca
    {
        protected InicializaDriver inicializaDriver = new InicializaDriver();
        private EncerraDriver encerra = new EncerraDriver();

        public void AbrirGrupoSeguranca()
        {
            ...
            IWebElement administrativo = inicializaDriver.ObterDriver().FindElement(By.XPath("//i[@class='kt-menu__link-icon menuSideIcon fas fa-shield-alt']"));
            ...
            IWebElement grupoSeguranca = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Grupo Segurança']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            grupoSeguranca.Click();
        }
