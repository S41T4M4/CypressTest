...
namespace ConciliadoraTestes.Testes.Admistrativo.MonitorMigracao
{
    public class MetodosMonitorMigracao
    {
        ...
        public void AbrirMonitorMigracao()
        {
            ...
            IWebElement monitorMigracao = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Monitor Migração']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            monitorMigracao.Click();
        }
