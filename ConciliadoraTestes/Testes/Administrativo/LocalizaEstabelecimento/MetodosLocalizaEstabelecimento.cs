...
{
    public class MetodosLocalizaEstabelecimento
    {
        protected InicializaDriver inicializaDriver = new InicializaDriver();
        private EncerraDriver encerra = new EncerraDriver();

        public void AbrirLocalizaEstabelecimento()
        {
            ...
            IWebElement localizaEstabelecimento = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Localiza Estabelecimento']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            localizaEstabelecimento.Click();
        }
