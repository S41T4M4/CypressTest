...
{
    public class MetodosTransferenciaEstabelecimentos
    {
        protected Driver inicializaDriver = new Driver();
        

        public void AbrirTransferenciaEstabelecimentos()
        {
            ...
            IWebElement transferenciaEstabelecimentos = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Transferência de Estabelecimentos']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            transferenciaEstabelecimentos.Click();
        }
