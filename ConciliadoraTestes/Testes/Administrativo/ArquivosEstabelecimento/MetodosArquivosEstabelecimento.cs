...
namespace ConciliadoraTestes.Testes.Admistrativo.ArquivosEstabelecimento
{
    public class MetodosArquivosEstabelecimento
    {
        ...
        public void AbrirArquivosEstabelecimento()
        {
            ...
            IWebElement arquivosEstabelecimento = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Arquivos por Estabelecimento']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            arquivosEstabelecimento.Click();
        }
