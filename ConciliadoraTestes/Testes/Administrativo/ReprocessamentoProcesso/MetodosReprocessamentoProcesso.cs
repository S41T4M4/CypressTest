...
{
    public class MetodosReprocessamentoProcesso
    {
        protected Driver inicializaDriver = new Driver();
        

        public void AbrirReprocessamentoProcesso()
        {
            ...
            inicializaDriver.Scroll(barra, 0, 300);

            IWebElement reprocessamentoProcesso = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Reprocessamento de Processo']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            reprocessamentoProcesso.Click();
        }
