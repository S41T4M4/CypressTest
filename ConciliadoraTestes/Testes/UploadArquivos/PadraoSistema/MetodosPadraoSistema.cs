...
namespace ConciliadoraTestes.Testes.UploadArquivos.PadraoSistema
{
    public class MetodosPadraoSistema
    {
        ...
        public void AbrirPadraoSistema()
        {
            ...
            IWebElement padraoSistema = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Padrão Sistema']"));
