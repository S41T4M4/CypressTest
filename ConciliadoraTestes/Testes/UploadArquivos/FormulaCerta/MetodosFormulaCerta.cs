...
{
    public class MetodosFormulaCerta
    {
        protected Driver inicializaDriver = new Driver();
        

        public void AbrirFormulaCerta()
        {
            ...
            IWebElement formulaCerta = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Fórmula Certa']"));
