...
{
    public class MetodosLumeSistemas
    {
        protected Driver inicializaDriver = new Driver();
        

        public void AbrirLumeSistemas()
        {
            ...
            IWebElement lumeSistemas = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Lume Sistemas']"));
