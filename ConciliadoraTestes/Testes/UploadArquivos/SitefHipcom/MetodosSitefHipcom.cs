...
{
    public class MetodosSitefHipcom
    {
        protected Driver inicializaDriver = new Driver();
        

        public void AbrirSitefHipcom()
        {
            ...
            IWebElement sitefHipcom = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Sitef Hipcom']"));
