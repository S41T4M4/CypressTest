...
namespace ConciliadoraTestes.Testes.UploadArquivos.CashMonitor
{
    public class MetodosCashMonitor
    {
        ...
        public void AbrirCashMonitor()
        {
            ...
            IWebElement cashMonitor = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Cash Monitor']"));
