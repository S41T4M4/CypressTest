...
{
    public class MetodosSolGerenciadorComercial
    {
        protected InicializaDriver inicializaDriver = new InicializaDriver();
        private EncerraDriver encerra = new EncerraDriver();

        public void AbrirSolGerenciadorComercial()
        {
            ...
            IWebElement solGerenciadorComercial = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='SOL Gerenciador Comercial']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            solGerenciadorComercial.Click();
        }
