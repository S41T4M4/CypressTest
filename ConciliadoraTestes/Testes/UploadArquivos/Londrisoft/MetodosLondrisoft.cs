...
{
    public class MetodosLondrisoft
    {
        protected Driver inicializaDriver = new Driver();
        

        public void AbrirLondrisoft()
        {
            ...
            IWebElement londrisoft = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Londrisoft']"));
