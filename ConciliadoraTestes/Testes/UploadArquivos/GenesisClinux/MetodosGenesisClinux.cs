...
namespace ConciliadoraTestes.Testes.UploadArquivos.GenesisClinux
{
    public class MetodosGenesisClinux
    {
        ...
        public void AbrirGenesisClinux()
        {
            ...
            IWebElement genesisClinux = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Gênesis - Clinux']"));
