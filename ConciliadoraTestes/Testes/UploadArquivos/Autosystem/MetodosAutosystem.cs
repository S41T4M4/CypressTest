...
namespace ConciliadoraTestes.Testes.UploadArquivos.Autosystem
{
    public class MetodosAutosystem
    {
        ...
        public void AbrirAutosystem()
        {
            ...
            IWebElement autosystem = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='AutoSystem']"));
