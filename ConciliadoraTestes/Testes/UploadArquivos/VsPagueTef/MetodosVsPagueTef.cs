...
namespace ConciliadoraTestes.Testes.UploadArquivos.VsPagueTef
{
    public class MetodosVsPagueTef
    {
        ...
        public void AbrirVsPagueTef()
        {
            ...
            IWebElement vsPagueTef = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='VSPague TEF']"));
