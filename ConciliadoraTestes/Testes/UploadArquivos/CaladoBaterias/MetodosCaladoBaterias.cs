...
namespace ConciliadoraTestes.Testes.UploadArquivos.CaladoBaterias
{
    public class MetodosCaladoBaterias
    {
        ...
        public void AbrirCaladoBaterias()
        {
            ...
            IWebElement caladoBaterias = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Calado Baterias']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            caladoBaterias.Click();
        }
