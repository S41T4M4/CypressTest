...
{
    public class MetodosLinxMicrovix
    {
        protected Driver inicializaDriver = new Driver();
        

        public void AbrirLinxMicrovix()
        {
            ...
            inicializaDriver.Scroll(barra, 0, 1000); //Chama o método de rolagem, passando como parâmentros a variável barra, e os valores para rolagem, em pixels

            IWebElement linxMicrovix = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Linx Microvix']"));
