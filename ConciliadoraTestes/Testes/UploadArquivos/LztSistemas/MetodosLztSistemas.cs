...
{
    public class MetodosLztSistemas
    {
        protected Driver inicializaDriver = new Driver();
        

        public void AbrirLztSistemas()
        {
            ...
            IWebElement lztSistemas = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='LztSistemas']"));
