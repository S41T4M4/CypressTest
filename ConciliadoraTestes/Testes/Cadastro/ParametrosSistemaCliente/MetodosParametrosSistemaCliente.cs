...
namespace ConciliadoraTestes.Testes.Cadastro.ParametrosSistemaCliente
{
    public class MetodosParametrosSistemaCliente
    {
        ...
        public void AbrirParametrosSistemaCliente()
        {
            ...
            IWebElement parametrosSistemaCliente = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Parâmetros Sistema Cliente']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            parametrosSistemaCliente.Click();
        }
