...
namespace ConciliadoraTestes.Testes.Cadastro.ParametrosCliente
{
    public class MetodosParametrosCliente
    {
        ...
        public void AbrirParametrosCliente()
        {
            ...
            IWebElement parametrosCliente = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Parâmetros Cliente']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            parametrosCliente.Click();
        }
