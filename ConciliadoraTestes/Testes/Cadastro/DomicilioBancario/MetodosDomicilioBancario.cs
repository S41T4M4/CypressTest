...
{
    public class MetodosDomicilioBancario
    {
        protected Driver inicializaDriver = new Driver();
        

        public void AbrirDomicilioBancario()
        {
            ...
            IWebElement domicilioBancario = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Domicílio Bancário']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            domicilioBancario.Click();
        }
