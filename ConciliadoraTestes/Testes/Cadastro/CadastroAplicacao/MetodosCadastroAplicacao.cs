...
namespace ConciliadoraTestes.Testes.Cadastro.CadastroAplicacao
{
    public class MetodosCadastroAplicacao
    {
        ...
        public void AbrirCadastroAplicacao()
        {
            ...
            IWebElement cadastroAplicacao = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Cadastro Aplicação']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            cadastroAplicacao.Click();
        }
