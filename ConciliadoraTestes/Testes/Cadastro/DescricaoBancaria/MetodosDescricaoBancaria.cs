...
{
    public class MetodosDescricaoBancaria
    {
        protected Driver inicializaDriver = new Driver();
        

        public void AbrirDescricaoBancaria()
        {
            ...
            IWebElement descricaoBancaria = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Descrição Bancária']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            descricaoBancaria.Click();
        }
