...
{
    public class MetodosCadastroVendedor
    {
        ...
        public void AbrirCadastroVendedor()
        {
            ...
            IWebElement cadastroVendedor = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Cadastro de Vendedor']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            cadastroVendedor.Click();
        }
