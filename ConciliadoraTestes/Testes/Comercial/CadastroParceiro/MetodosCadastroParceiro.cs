...
{
    public class MetodosCadastroParceiro
    {
        protected Driver inicializaDriver = new Driver();
        

        public void AbrirCadastroParceiro()
        {
            ...
            IWebElement administrativo = inicializaDriver.ObterDriver().FindElement(By.XPath("//i[@class='kt-menu__link-icon menuSideIcon fas fa-comments-dollar']"));
            ...
            IWebElement cadastroParceiro = inicializaDriver.ObterDriver().FindElement(By.XPath("//span[text()='Cadastro Parceiro']"));
            inicializaDriver.ObterDriver().Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(30);
            cadastroParceiro.Click();
        }
